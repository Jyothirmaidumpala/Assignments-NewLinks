...
namespace MVC_Assignment1.Models
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        [DbFunction("NorthwindEntities", "GetCustomerByCountry")]
        public virtual IQueryable<GetCustomerByCountry_Result> GetCustomerByCountry(string country)
        {
            var countryParameter = country != null ?
                new ObjectParameter("country", country) :
                new ObjectParameter("country", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetCustomerByCountry_Result>("[NorthwindEntities].[GetCustomerByCountry](@country)", countryParameter);
        }
